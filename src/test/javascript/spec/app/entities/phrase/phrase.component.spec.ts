...
import { PhraseComponent } from 'app/entities/phrase/phrase.component';
import { PhraseService } from 'app/entities/phrase/phrase.service';
import { Phrase } from 'app/shared/model/phrase.model';

describe('Component Tests', () => {
  describe('Phrase Management Component', () => {
    let comp: PhraseComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PhraseComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.phrases && comp.phrases[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
