...
describe('Service Tests', () => {
  describe('Phrase Service', () => {
    ...
    let elemDefault: IPhrase;
    let expectedResult: IPhrase | IPhrase[] | boolean | null;
    beforeEach(() => {
      ...
      elemDefault = new Phrase(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Phrase', () => {
        const returnedFromService = Object.assign(
          {
            author: 'BBBBBB',
            text: 'BBBBBB',
